...
setwd("I:/MidAtlantic_GOM_Work/SDM_Climate_Projecting/Script for Downloading NOAA Climate Data")
...
for (per in period){
  for (sea in season){
    for (var in variables){
      ...
      {
      mybrowser$setImplicitWaitTimeout(milliseconds=30000) ##have it wait until browser window loads
      ...
      option$clickElement()
      {
      mybrowser$setImplicitWaitTimeout(milliseconds=30000) ###make it wait for awhile until element appears, explicit waiting
      ...
      old=paste("C:/Users/jennifer.mchenry/Downloads/",name,sep="")
      new=paste("C:/Users/jennifer.mchenry/Downloads/",var,"_",sea,"_",per,".nc",sep="")
      print(new)
