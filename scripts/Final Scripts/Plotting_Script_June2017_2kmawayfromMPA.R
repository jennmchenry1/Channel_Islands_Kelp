...
DF_SE_ALL<-subset(DF_SE_ALL,DF_SE_ALL$YEAR>=1995)
...
tiff(filename = paste("Yearly_Kelp_Difference_Between_Pixels_Smoothed_lessthan_5km_distMPA_post1995.tiff",sep=""),width = 15,height = 6,units = "in",res = 300)
grid_arrange_shared_legend(Plot_4,Plot_5,Plot_9,Plot_10,Plot_2,Plot_1,Plot_7,Plot_6,Plot_8,Plot_3,nrow = 2,ncol = 5)
dev.off()
